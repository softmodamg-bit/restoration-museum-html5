...
- 정적 HTML5 배포, 마우스·터치 지원, 기존 `localStorage` 세이브 호환성을 유지한다. GitHub Pages는 `.github/workflows/pages.yml`에서 정적 파일을 올리며, 기본 게시 작업의 10분 제한으로 인한 시간초과를 피하도록 배포 대기 한도를 30분으로 둔다.
