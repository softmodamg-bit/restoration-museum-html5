...
assert.match(index, /styles\.css\?v=20260806-mobile-gameplay-v2/);
assert.match(index, /js\/game\.js\?v=20260806-mobile-gameplay-v2/);
...
console.log("Mobile gameplay layout OK: compact navigation, play-first ordering, two-row status HUD, tool-to-game auto focus, and shorter interactive stages verified.");
